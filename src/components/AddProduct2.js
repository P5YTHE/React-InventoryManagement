...
function AddProduct2() {
        ...
        function ShowSizeinput(){
            console.log("showsizeinput working");
            if(sizesExist==true)
           {
            return(
                <SizesInput productId={productData.productId}/>
            );
          }
  ...
  return (
    <React.Fragment>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
        <Button onClick={()=> alert("Product added!")} type="submit" size="medium"  variant="outlined">
                 Add Product
             </Button>
